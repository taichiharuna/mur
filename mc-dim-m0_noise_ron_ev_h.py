...
for i in range(M):
    f = open("mc-dim-m0_noise_ron_a{:.2f}_e{:.2f}_n{:d}_tr{:d}.txt".format(alpha,ep,n,i),"w")
    g = open("ev_noise_ron_a{:.2f}_e{:.2f}_n{:d}_tr{:d}.txt".format(alpha,ep,n,i),"w")
    h = open("hvar_noise_ron_a{:.2f}_e{:.2f}_n{:d}_tr{:d}.txt".format(alpha,ep,n,i),"w")
...
f = open("mc-dim-m0_noise_ron_a{:.2f}_e{:.2f}_n{:d}.txt".format(alpha,ep,n),"w")
...
f = open("hc-hdim-h0_noise_ron_a{:.2f}_e{:.2f}_n{:d}.txt".format(alpha,ep,n),"w")
for i,delta in enumerate(deltas):
